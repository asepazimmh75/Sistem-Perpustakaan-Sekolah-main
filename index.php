...
<html lang="en">
  <head>
    ...
    <title>Gudang Ilmu</title>
    <link rel="icon" href="assets/newLogo.png" type="image/png">
  </head>
  <body>
    <!--Navbar-->
    <nav class="navbar fixed-top navbar-expand-lg bg-body-tertiary shadow-sm justify-space-between">
      <div class="container-fluid">
        <img src="assets/newLogo.png" alt="logo" width="120px">
    ...
    <section id="homeSection" class="p-5">
      <div class="d-flex flex-wrap justify-content-center">
        <div class="col mt-5">
          <img src="assets/newLogo.png" alt="Gudang Ilmu Logo" class="img-fluid">
          <p class="mb-4">"Temukan Dunia Pengetahuan di Ujung Jari Anda: <br> Perpustakaan Online <span class="fw-bold">Gudang Ilmu</span> Membawa Anda ke Dunia Buku Digital."</p>
    ...
    <section class="bg-body-secondary p-5" id="aboutSection">
      ...
      <div class="d-flex justify-content-center flex-wrap gap-4 mt-4">
        <div class="card border-info mb-3" style="max-width: 18rem;">
          <div class="card-header">Group 6</div>
          <div class="card-body">
            <h5 class="card-title">Student At ARS University</h5>
          </div>
        </div>
      </div>
    </section>
    ...
    <footer id="footer" class="p-3 bg-dark">
      <div class="row">
        <div class="col">
          <img src="assets/logoFooterNew.png" width="200px">
        </div>
      </div>
      <div class="row p-3">
        <div class="col mt-3">
          <h3 class="text-light fs-5">Alamat</h3>
          <p class="text-secondary fs-6">1-2 Jl. Sekolah Internasional 40132 Kota Bandung West Java</p>
        </div>
        ...
        <div class="d-flex justify-content-center align-items-center mt-3">
          <p class="text-light">Made width ❤️ <a href="" class="text-decoration-none">Group 6</a>  2024</p>
        </div>
      </div>
    </footer>
